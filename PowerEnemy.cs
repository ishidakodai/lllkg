...
public class PowerEnemy : MonoBehaviour
{
    ...
    public void Attack(GameObject Player)//攻撃処理
    {
        ...
        {            
            #region 攻撃の処理
            audioSource.PlayOneShot(PowerSE);//効果音を一回だけ鳴らす
            anim.SetBool("PowerAttack", true);//攻撃アニメーションを流す
    ...
    {
        anim.SetBool("PowerAttack", false);//攻撃アニメーション終わり
        speed = Go;//攻撃終わったら動く
    }
